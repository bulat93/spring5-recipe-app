...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes(){
        ...
        Optional<UnitOfMeasure> eachUomOfOptional = unitOfMeasureRepository.findByDescription("Each");
        if (!eachUomOfOptional.isPresent()){
            throw new RuntimeException("Excepted UOM Not Found");
        }

        Optional<UnitOfMeasure> tableSpoonUomOfOptional = unitOfMeasureRepository.findByDescription("Tablespoon");
        if (!tableSpoonUomOfOptional.isPresent()){
            throw new RuntimeException("Excepted UOM Not Found");
        }

        Optional<UnitOfMeasure> teaSpoonUomOfOptional = unitOfMeasureRepository.findByDescription("Teaspoon");
        if (!teaSpoonUomOfOptional.isPresent()){
            throw new RuntimeException("Excepted UOM Not Found");
        }

        Optional<UnitOfMeasure> dashUomOfOptional = unitOfMeasureRepository.findByDescription("Teaspoon");
        if (!dashUomOfOptional.isPresent()){
            throw new RuntimeException("Excepted UOM Not Found");
        }

        Optional<UnitOfMeasure> pintUomOfOptional = unitOfMeasureRepository.findByDescription("Pint");
        if (!pintUomOfOptional.isPresent()){
            throw new RuntimeException("Excepted UOM Not Found");
        }

        Optional<UnitOfMeasure> cupUomOfOptional = unitOfMeasureRepository.findByDescription("Cup");
        if (!cupUomOfOptional.isPresent()){
            throw new RuntimeException("Excepted UOM Not Found");
        }

        UnitOfMeasure eachUom = eachUomOfOptional.get();
        UnitOfMeasure tableSpoonUom = tableSpoonUomOfOptional.get();
        UnitOfMeasure teapoonUom = teaSpoonUomOfOptional.get();
        UnitOfMeasure dashUom = dashUomOfOptional.get();
        UnitOfMeasure pintUom = pintUomOfOptional.get();
        UnitOfMeasure cupsUom = cupUomOfOptional.get();
